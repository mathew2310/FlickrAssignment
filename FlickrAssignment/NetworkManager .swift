...
protocol flickrNetwork {
    ...
    func getImage(searchLine: String)
}
...
class flickrNetworkClass: flickrNetwork {    
    ...
    func getImage(searchLine: String) {
        ...
        let urlstr = "https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key= 0e08e76eff544231b992197c7c7c22a9&text=\(searchLine)&format=json&nojsoncallback=1"
